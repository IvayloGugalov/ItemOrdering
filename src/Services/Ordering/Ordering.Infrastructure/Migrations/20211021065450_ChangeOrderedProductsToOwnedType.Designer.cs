...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ItemOrdering.Domain.ShoppingCartAggregate.ProductAndAmount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ItemOrdering.Domain.OrderAggregate.Order", b =>
                {
                    ...
                    b.OwnsMany("ItemOrdering.Domain.OrderAggregate.OrderedProduct", "OrderedProducts", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int")
            ...
            modelBuilder.Entity("ItemOrdering.Domain.ShoppingCartAggregate.ProductAndAmount", b =>
                {
                    b.HasOne("ItemOrdering.Domain.ShoppingCartAggregate.ShoppingCart", null)
                        .WithMany("ProductsAndAmount")
            ...
            modelBuilder.Entity("ItemOrdering.Domain.ShoppingCartAggregate.ShoppingCart", b =>
                {
                    b.Navigation("ProductsAndAmount");
                });
